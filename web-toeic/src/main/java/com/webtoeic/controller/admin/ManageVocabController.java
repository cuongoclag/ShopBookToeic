	 ...
	 @RequestMapping("/vocab/saveVocab")
	    public String uploadingPost(
             @RequestParam("file_imageQuestion") MultipartFile[] file_imageQuestions
	    		...
	    		, @ModelAttribute("baitaptuvung") VocabularyExercises baitaptuvung, BindingResult result
		 ...
		 baitaptuvung.setVocabularyImage(file_imageVocab.getOriginalFilename());
		 ...
		 List<VocabularyContent> noidungbttuvungList = new ArrayList<VocabularyContent>();
		    ...
		    for(int i=0;i<worksheet.getPhysicalNumberOfRows() ;i++) {
		        ...
		        noidungbaitaptuvung.setVocabularyExercises(baitaptuvung);
			...
			String error = "Có lỗi xảy ra, update or add again, id ="+baitaptuvung.getId();
