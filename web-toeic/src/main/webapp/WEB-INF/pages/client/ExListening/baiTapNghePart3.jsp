	...
	<div class="container">
		...
		<div class="row">
			<div class="span9" style="text-align: center">
				<!--Blog Post-->
				<div class="blog-post">
					<h3>${listeningExercises.tenBaiNghe}</h3>
					<input type="hidden" value="${listeningExercises.id }" id="baiTapNgheId">
					<div class="postmetadata">
						<a name="middle">
							<ul>
								<li><c:if test="${listeningExercises.doKho == 1}">
                                    Độ khó - Dễ 
                                </c:if> <c:if test="${listeningExercises.doKho == 2}">
                                    Độ khó - Trung bình
                                </c:if> <c:if test="${listeningExercises.doKho == 3}">
                                    Độ khó - Khó
                                </c:if></li>
							</ul>
						</a>
					</div>
					<img src="<c:url value="/file/images/baiNgheId=${listeningExercises.id }.png"  />"
						style="width: 300px; height: 150px;">
					<p>Listen audio and answer the questions</p>
					<audio controls
						src="<c:url value="/file/audio/baiNgheId=${listeningExercises.id }.mp3"  />"></audio>
				</div>
				...
				<div>
					...
					<a class="btn btn-success hidden" id="btnBaiThiKhac"
						href="/listening">Làm bài thi khác</a>
				</div>
