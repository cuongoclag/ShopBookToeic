...
<head>
    ...
    <!-- Stylesheets -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/shop/css/bootstrap.min.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/shop/css/plugins.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/shop/css/style.css">

    <!-- Cusom css -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/shop/css/custom.css">

    <!-- Modernizer js -->
    <script src="${pageContext.request.contextPath}/resources/shop/js/vendor/modernizr-3.5.0.min.js"></script>
</head>
<body>
<!--[if lte IE 9]>
                ...
                <div class="col-lg-8 d-none d-lg-block">
                    <nav class="mainmenu__nav">
                        <ul class="meninmenu d-flex justify-content-start">
                            ...
                            <li class="drop"><a href="<%=request.getContextPath()%>/hometoeic">Learn English</a>
...
<!-- JS Files -->
<script src="${pageContext.request.contextPath}/resources/shop/js/vendor/jquery-3.2.1.min.js"></script>
<script src="${pageContext.request.contextPath}/resources/shop/js/popper.min.js"></script>
<script src="${pageContext.request.contextPath}/resources/shop/js/bootstrap.min.js"></script>
<script src="${pageContext.request.contextPath}/resources/shop/js/plugins.js"></script>
<script src="${pageContext.request.contextPath}/resources/shop/js/active.js"></script>
