	...
	<div class="container">
		...
		<div class="row">
			<div class="span9" style="text-align: center">
				<!--Blog Post-->
				<div class="blog-post">
					<h3>${readingExercises.tenBaiDoc}</h3>
					<input type="hidden" value="${readingExercises.id }" id="baiTapDocId">
					<div class="postmetadata">
						<a name="middle">
							<ul>
								<li><c:if test="${readingExercises.doKho == 1}">
                                    Độ khó - Dễ 
                                </c:if> <c:if test="${readingExercises.doKho == 2}">
                                    Độ khó - Trung bình
                                </c:if> <c:if test="${readingExercises.doKho == 3}">
                                    Độ khó - Khó
                                </c:if></li>
							</ul>
						</a>
					</div>
					<img src="<c:url value="/file/images/baiDocId=${readingExercises.id }.png"  />"
				...
				<div class="span9" style="text-align: center">
					...
					<a class="btn btn-success hidden" id="btnBaiThiKhac"
						href="/bai-doc">Làm bài thi khác</a>
				</div>
